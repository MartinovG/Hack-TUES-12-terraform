...
dependency "ecs" {
  config_path = "../ecs"
  mock_outputs = {
    cluster_name    = "prod-hack-tues-12-cluster"
    alb_arn         = "arn:aws:elasticloadbalancing:us-east-1:000000000000:loadbalancer/app/prod-placeholder/0000000000000000"
    frontend_tg_arn = "arn:aws:elasticloadbalancing:us-east-1:000000000000:targetgroup/prod-placeholder/0000000000000000"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan"]
}
...
dependency "postgres" {
  ...
  mock_outputs = {
    instance_id = "hack-tues-12-prod-postgres"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan"]
}
