...
dependency "ecs" {
  config_path = "../ecs"
  mock_outputs = {
    cluster_name                       = "route-optimizer-prod"
    core_app_task_arn_without_revision = { backend = "arn:aws:ecs:us-east-1:123456789012:task-definition/prod-route-optimizer-backend" }
    frontend_task_arn_without_revision = { frontend = "arn:aws:ecs:us-east-1:123456789012:task-definition/prod-route-optimizer-frontend" }
    service_task_arn_without_revision  = { algorithms = "arn:aws:ecs:us-east-1:123456789012:task-definition/prod-route-optimizer-algorithms" }
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan", "init"]
}
