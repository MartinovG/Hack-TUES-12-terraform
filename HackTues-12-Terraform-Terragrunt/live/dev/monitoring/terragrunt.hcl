...
dependency "ecs" {
  config_path = "../ecs"
  mock_outputs = {
    cluster_name    = "dev-hack-tues-12-cluster"
    alb_arn         = "arn:aws:elasticloadbalancing:us-east-1:000000000000:loadbalancer/app/dev-placeholder/0000000000000000"
    frontend_tg_arn = "arn:aws:elasticloadbalancing:us-east-1:000000000000:targetgroup/dev-placeholder/0000000000000000"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan", "init"]
}
...
dependency "postgres" {
  ...
  mock_outputs = {
    instance_id = "hack-tues-12-dev-postgres"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan", "init"]
}
